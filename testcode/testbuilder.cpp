...
// This test validates the non-legacy mode transaction id generated by builder.
HRESULT CTestBuilder::Test3()
{
    HRESULT hr = S_OK;
    CStunMessageBuilder builder;
    CStunMessageReader reader;
    ...
    ChkIfA(CStunMessageReader::BodyValidated != reader.AddBytes(spBuffer->GetData(), spBuffer->GetSize()), E_FAIL);
    ChkIf(reader.IsMessageLegacyFormat() == true, E_FAIL);

Cleanup:
    return hr;
}

// This test validates the legacy mode transaction id generated by builder.
HRESULT CTestBuilder::Test4()
{
    HRESULT hr = S_OK;
    CStunMessageBuilder builder;
    CStunMessageReader reader;
    ...
    ChkIfA(CStunMessageReader::BodyValidated != reader.AddBytes(spBuffer->GetData(), spBuffer->GetSize()), E_FAIL);
    ChkIf(reader.IsMessageLegacyFormat() == false, E_FAIL);
